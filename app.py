...
st.caption("⚠️ Valid range: 30 to 150 USD. This app is designed for subscription based businesses such as phone carriers, internet providers, and insurance companies. The monthly charge is capped at 150 USD due to the limits of the training data — entering values outside this range may produce unreliable results.")
